...
BASE_CKPT = Path(
  "logs/rsl_rl/mos92_velocity/2026-06-07_03-27-15_spike_v3g_goal/model_1400.pt"
)
NUM_ENVS = 1024
MAX_ITER = 2000
...
def main() -> None:
  ...
  agent_cfg.run_name = "spike_v3g_goal_stable"
  agent_cfg.save_interval = 100

  log_root = Path("logs/rsl_rl") / agent_cfg.experiment_name
  stamp = datetime.now().strftime("%Y-%m-%d_%H-%M-%S_spike_v3g_goal_stable")

...
soccer_eval/2026-06-16_v4_amp/kick_strike_amp_exp24/:
  - kick_strike_amp_exp24_pov_belief.mp4
...
def main() -> None:
  info = run(
    ...
    CKPT,
    OUT_DIR,
    "kick_strike_amp_exp24",
    "EXP23 (strike+AMP human gait): robot POV + self-localization belief",
  )

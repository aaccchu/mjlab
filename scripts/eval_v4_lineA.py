...
soccer_eval/2026-06-09_v4/lineA_ekf/:
...
CKPT = Path("checkpoints/v4_soccer/lineA_ekf_exp13/model_1999.pt")
OUT_DIR = Path("soccer_eval/2026-06-09_v4/lineA_ekf")
VIDEO_NUM_ENVS = 9
VIDEO_LEN = 500
METRIC_NUM_ENVS = 128
METRIC_STEPS = 400
...
def render_video(device: str) -> None:
  env_cfg = mos92_soccer_e2e_dualcam_ekf_env_cfg(play=True)

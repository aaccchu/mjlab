...
def main() -> None:
  ...
  env_cfg = mos92_soccer_selfloc_realspec_env_cfg(play=False)
  ...
  agent_cfg.run_name = "spike_v3g_selfloc_realspec"
  agent_cfg.save_interval = 100

  log_root = Path("logs/rsl_rl") / agent_cfg.experiment_name
  stamp = datetime.now().strftime("%Y-%m-%d_%H-%M-%S_spike_v3g_selfloc_realspec")

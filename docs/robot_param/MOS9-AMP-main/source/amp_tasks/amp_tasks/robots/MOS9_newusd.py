...
MOS9_CYLINDER_CFG_NEW = ArticulationCfg(
  spawn=sim_utils.UsdFileCfg(
    usd_path=f"{ASSET_DIR}/MOS/MOS92_urdf_0517_v3/usd/MOS92_urdf_0517_v3_simplified.usd",
...
MOS9_ACTION_SCALE_NEW = {}
for actuator in MOS9_CYLINDER_CFG_NEW.actuators.values():
  ...
  for name in names:
    if name in effort and name in stiffness and stiffness[name]:
      MOS9_ACTION_SCALE_NEW[name] = 0.25 * effort[name] / stiffness[name]
